...
class CompletedScheduleAD extends StatefulWidget {
  const CompletedScheduleAD({super.key});

  @override
  State<CompletedScheduleAD> createState() => _CompletedScheduleADState();
}

class _CompletedScheduleADState extends State<CompletedScheduleAD> {
  late String userId;
  @override
  void initState() {
    super.initState();
